            ...
            {loading ? (
                ...
                <div className="min-h-screen flex items-center justify-center flex-col gap-4 p-8 text-center text-slate-900 bg-white">
                    ...
                    <div className="flex flex-col gap-3 w-full max-w-xs mt-6">
                        {company.phone && (
                            <a href={`tel:${formatDialNumber(company.phone)}`} className="w-full bg-emerald-600 text-white py-4 rounded-2xl font-black uppercase tracking-widest shadow-xl shadow-emerald-100 flex items-center justify-center gap-2">
